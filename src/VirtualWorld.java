    ...
    public void mousePressed() {
        ...
        if (entityOptional.isPresent()) {
            ...
            if (entity instanceof PlantEntity){
                System.out.println(entity.getID() + ": " + entity.getClass() + " : " + ((PlantEntity)entity).getHealth());
            }
        }
        else{
            Entity fire = Creations.createFire("house_" + pressed.x + "_" + pressed.y, pressed, imageStore.getImageList(Functions.FIRE_KEY));
            world.addEntity(fire);
            ((Fire) fire).executeActivity(world, imageStore, scheduler);
